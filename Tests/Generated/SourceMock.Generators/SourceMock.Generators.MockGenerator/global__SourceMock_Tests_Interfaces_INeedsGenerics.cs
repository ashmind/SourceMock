...
namespace SourceMock.Tests.Interfaces.Mocks {
    public class NeedsGenericsMock : global::SourceMock.Tests.Interfaces.INeedsGenerics, INeedsGenericsSetup, INeedsGenericsCalls, SourceMock.IMock<global::SourceMock.Tests.Interfaces.INeedsGenerics> {
        ...
        SourceMock.Interfaces.IMockMethodSetup<System.Func<T>,T> INeedsGenericsSetup.Get<T>() => _get2Handler.Setup<System.Func<T>, T>(new[] { typeof(T) }, null);
        ...
        SourceMock.Interfaces.IMockMethodSetup<System.Action<T?>> INeedsGenericsSetup.SetOptional<T>(SourceMock.Internal.MockArgumentMatcher<T?> value) where T: default => _setOptional3Handler.Setup<System.Action<T?>, SourceMock.Internal.VoidReturn>(new[] { typeof(T) }, new SourceMock.Internal.IMockArgumentMatcher[] { value });
