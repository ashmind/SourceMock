...
namespace SourceMock.Tests.Interfaces.Mocks {
    public class NeedsGenericsMock : global::SourceMock.Tests.Interfaces.INeedsGenerics, INeedsGenericsSetup, INeedsGenericsCalls, SourceMock.IMock<global::SourceMock.Tests.Interfaces.INeedsGenerics> {
        ...
        SourceMock.IMockMethodSetup INeedsGenericsSetup.SetOptional<T>(SourceMock.Internal.MockArgumentMatcher<T?> value) where T: default => _setOptional3Handler.Setup<System.Action<T?>, SourceMock.Internal.VoidReturn>(new[] { typeof(T) }, new SourceMock.Internal.IMockArgumentMatcher[] { value });
        ...
        SourceMock.IMockMethodSetup<System.Action,global::System.Collections.Generic.IEnumerable<T?>> INeedsGenericsSetup.GetAll<T>() where T: default => _getAll4Handler.Setup<System.Action, global::System.Collections.Generic.IEnumerable<T?>>(new[] { typeof(T) }, null);
        public global::System.Collections.Generic.IEnumerable<T?> GetAll<T>() => _getAll4Handler.Call<System.Action, global::System.Collections.Generic.IEnumerable<T?>>(new[] { typeof(T) }, null);
    ...
    public interface INeedsGenericsSetup {
        ...
        SourceMock.IMockMethodSetup<System.Action,global::System.Collections.Generic.IEnumerable<T?>> GetAll<T>();
    }
